...
release:
	...
	@-rsync -av --exclude='source' --exclude='build' --exclude='agb_inject_mb.elf' --exclude='gba.cxi' --exclude='inject.sav' --exclude='Makefile' --exclude='out*' --exclude='out*' agb_inject $(RELEASE)
